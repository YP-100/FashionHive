              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div>
                  ...
                  <Button
                    ...
                    className="group flex items-center gap-3 rounded-xl px-4 py-3 shadow-md transition-all duration-200 hover:scale-105"
                    variant="contained"
                    sx={{ bgcolor: "#ca8a04" }}
                  >
                            ...
                            <div key={item.name} className="group relative text-sm">
                              ...
                              <p
                                onClick={() => handleCategoryClick(
                                  category,
                                  category.sections[0], // using first section as default
                                  item,
                                  () => setOpen(false))}
                ...
                {auth.user?.role === 'ADMIN' && (
                  <button
                    ...
                    className="bg-yellow-600 text-white px-4 py-2 rounded hover:bg-blue-700 m-4"
                  >
                    Admin Panel
                  </button>
                )}
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center px-11">
              ...
              {auth.user?.role === 'ADMIN' && (
                <button
                  onClick={() => navigate('/admin')}
                  className="bg-yellow-600 text-white rounded px-2 hover:bg-blue-700 m-4"
                >
                  Admin Panel
                </button>
              )}
                ...
                <div className="flex items-center lg:ml-6">
                  {showSearchBar ? (
                    <div className="relative">
                      <input
                        ...
                        onKeyPress={(e) => {
                          if (e.key === 'Enter' && searchQuery.trim()) {
                            ...
                            navigate(`/products/search?title=${encodedQuery}`);
                      ...
                      />
                      <XMarkIcon
                        className="h-5 w-5 absolute right-2 top-3 text-gray-400 cursor-pointer"
                        onClick={() => {
                          setShowSearchBar(false);
                          setSearchQuery("");
                        }}
