...
export const OUT_DELIVERY_ORDER_REQUEST = 'OUT_DELIVERY_ORDER_REQUEST';
export const OUT_DELIVERY_ORDER_SUCCESS = 'OUT_DELIVERY_ORDER_SUCCESS';
export const OUT_DELIVERY_ORDER_FAILURE = 'OUT_DELIVERY_ORDER_FAILURE';
